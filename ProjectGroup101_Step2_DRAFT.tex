...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item \textbf{releaseYear}: year(4) -- Year the game was released
...
\begin{itemize}[leftmargin=2em]
    ...
    \item \textbf{Games}: \texttt{gameID} $\rightarrow$ \texttt{title}, \texttt{releaseYear}, \texttt{developer}. No transitive dependency (developer does not determine releaseYear or title within this table -- different games by the same developer have different titles and release years).
