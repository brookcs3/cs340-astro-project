...
--
-- Citation (accessed Jan-Mar 2026): DDL structure follows CS340 course guidelines and MySQL 8.0 syntax.
...
-- ========================================================
-- STORED PROCEDURE: sp_reset_database
-- Restores all tables and sample data to their original state.
-- Called by the "Reset Database" button on the Home page.
-- Citation: AI-assisted (Claude) for initial scaffolding; adapted by Cameron Brooks.
-- ========================================================
...
BEGIN
    ...
    INSERT INTO RunSubmissions (runTime, submissionDate, verified, verifiedDate, playerID, gameID, platformID, runCategoryID, videoLink)
    SELECT '00:15:35.230', '2026-01-10', TRUE, '2026-01-11', p.playerID, g.gameID, pl.platformID, rc.runCategoryID, 'https://youtube.com/example1'
    FROM Players p JOIN Games g ON g.title = 'Super Mario 64' JOIN Platforms pl ON pl.name = 'Nintendo 64' JOIN RunCategories rc ON rc.name = 'Any%' AND rc.gameID = g.gameID WHERE p.displayName = 'SpeedDemon42';

    INSERT INTO RunSubmissions (runTime, submissionDate, verified, verifiedDate, playerID, gameID, platformID, runCategoryID, videoLink)
    SELECT '00:49:12.800', '2026-01-15', TRUE, '2026-01-16', p.playerID, g.gameID, pl.platformID, rc.runCategoryID, 'https://youtube.com/example2'
    FROM Players p JOIN Games g ON g.title = 'Super Mario 64' JOIN Platforms pl ON pl.name = 'Nintendo 64' JOIN RunCategories rc ON rc.name = '16 Star' AND rc.gameID = g.gameID WHERE p.displayName = 'SpeedDemon42';

    INSERT INTO RunSubmissions (runTime, submissionDate, verified, verifiedDate, playerID, gameID, platformID, runCategoryID, videoLink)
    SELECT '00:18:22.450', '2026-01-20', FALSE, NULL, p.playerID, g.gameID, pl.platformID, rc.runCategoryID, 'https://twitch.tv/example3'
    FROM Players p JOIN Games g ON g.title = 'The Legend of Zelda: Ocarina of Time' JOIN Platforms pl ON pl.name = 'Nintendo Switch' JOIN RunCategories rc ON rc.name = 'Any%' AND rc.gameID = g.gameID WHERE p.displayName = 'PixelRunner';

    INSERT INTO RunSubmissions (runTime, submissionDate, verified, verifiedDate, playerID, gameID, platformID, runCategoryID, videoLink)
    SELECT '00:32:45.110', '2026-02-01', TRUE, '2026-02-02', p.playerID, g.gameID, pl.platformID, rc.runCategoryID, NULL
    FROM Players p JOIN Games g ON g.title = 'Celeste' JOIN Platforms pl ON pl.name = 'PC' JOIN RunCategories rc ON rc.name = 'Any%' AND rc.gameID = g.gameID WHERE p.displayName = 'GlitchHunter';

    INSERT INTO RunSubmissions (runTime, submissionDate, verified, verifiedDate, playerID, gameID, platformID, runCategoryID, videoLink)
    SELECT '00:14:08.670', '2026-02-03', FALSE, NULL, p.playerID, g.gameID, pl.platformID, rc.runCategoryID, 'https://youtube.com/example5'
    FROM Players p JOIN Games g ON g.title = 'Portal' JOIN Platforms pl ON pl.name = 'PC' JOIN RunCategories rc ON rc.name = 'Inbounds' AND rc.gameID = g.gameID WHERE p.displayName = 'NightOwlPlays';
